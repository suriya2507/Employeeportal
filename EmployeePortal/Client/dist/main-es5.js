...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationInterceptor = /** @class */ (function () {
                ...
                AuthenticationInterceptor.prototype.handleUnauthorized = function (err) {
                    if (err.status === 401) {
                ...
                AuthenticationInterceptor.prototype.intercept = function (req, next) {
                    var _this = this;
                    var token = localStorage.getItem(_user_service__WEBPACK_IMPORTED_MODULE_1__["TOKEN_STORAGE_KEY"]);
                    if (token) {
                    ...
                    return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (x) { return _this.handleUnauthorized(x); }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormComponent = /** @class */ (function () {
                function FormComponent(http, baseUrl, formBuild, userService) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!!window.sessionStorage.getItem("jwt_token")) return [3 /*break*/, 2];
                                    return [4 /*yield*/, this.userService.registerUser({ Email: this.registerForm.value.email, Password: this.registerForm.value.password }).toPromise()];
                                case 1:
                                    token = _a.sent();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(formBuild, userService) {
                    this.formBuild = formBuild;
                    this.userService = userService;
                    this.submitted = false;
                    this.hide = true;
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.userService.login({ login: this.loginForm.value.userName, password: this.loginForm.value.password })];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterComponent = /** @class */ (function () {
                function RegisterComponent(http, baseUrl) {
                ...
                RegisterComponent.prototype.register = function () {
                    ...
                    this.httpClient.post(this.bUrl + 'registration', this.registration).subscribe(function (result) {
                        _this.status = result;
                    }, function (error) { return console.error(error); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.registerUser = function (model) {
                ...
                UserService.prototype.login = function (model) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.httpClient.post(this.LOGIN_ROUTE, model)
                                        .toPromise()];
                                case 1:
                                    response = _a.sent();
